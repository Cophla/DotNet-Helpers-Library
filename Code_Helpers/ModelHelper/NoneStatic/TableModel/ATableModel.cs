...
{
	public abstract class ATableModel<T> : ITableModel<T>
	{
		...
		public abstract SqlDataReader GetAll();
		public abstract SqlDataReader GetAll(SqlConnection connection);
		public abstract SqlDataReader GetAll(MessageString errorMsg);
		public abstract SqlDataReader GetAll(out string errorMsg);
		public abstract SqlDataReader GetAll(SqlConnection connection, MessageString errorMsg);
		public abstract SqlDataReader GetAll(SqlConnection connection, CommandBehavior commandBehavior);
		public abstract SqlDataReader GetAll(SqlConnection connection, out string errorMsg);
